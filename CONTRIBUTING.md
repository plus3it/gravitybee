...
GravityBee could always use more documentation, whether as part of the official
GravityBee docs, in docstrings, or even on the web in blog posts, articles, and
...
To set up GravityBee for local development:

1.  Fork [GravityBee](https://github.com/plus3it/gravitybee) (look for the
    "Fork" button).

2.  Clone your fork locally:

    ```shell
    git clone https://github.com/your_name_here/gravitybee.git && cd gravitybee
    ```
...
[0]: https://github.com/plus3it/gravitybee/issues
[1]: https://travis-ci.org/plus3it/gravitybee/pull_requests
